...
const ProductsContainer = () => {
  ...
  return (
    <>
      ...
      {/* PRODUCTS */}
      <div>{totalProducts === 0 ? <h5 className="text-2xl mt-16">Sorry, we couldn't find any products with your preferences...</h5> : layout === "grid" ? <ProductsGrid /> : <ProductsList />}</div>
    </>
  );
};
